...
/*
 * Kamailio-Go - LRKProxy module tests.
 */
...
var testInvite = []byte("INVITE sip:bob@example.com SIP/2.0\r\n" +
	...
	"Call-ID: call-123@pc33.example.com\r\n" +
	"CSeq: 1 INVITE\r\n" +
	"Content-Length: 0\r\n\r\n")
...
func TestOfferAnswerDelete(t *testing.T) {
	...
	if err := m.Delete("call-123@pc33.example.com"); err != nil {
...
func TestGlobalFunctions(t *testing.T) {
	Init()
	if DefaultLRKProxy() == nil {
		t.Fatal("expected non-nil default")
	}
	if !DefaultLRKProxy().Ping() {
